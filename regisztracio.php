<?php
  ...
  if ($aid == null && !isset($_SESSION["uid"])) { // ha nincs $aid és nincs belépve, akkor kell reg. űrlap
...
?>
  ...
  <div class="container">
    ...
    <form class="col-sm-6 col-sm-push-3" action="" method="post">
      ...
      <div class="checkbox">
        <label><input type="checkbox" name="elfogad" id="elfogad" value="1" required> Elolvastam és elfogadom a <a href="#">felhasználási feltételek</a>et.</label>
      </div>

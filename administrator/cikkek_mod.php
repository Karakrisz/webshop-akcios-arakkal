...
?>
  ...
  <div class="container">
    <h1 class="text-center">Cikk módosítása</h1>
    <form class="col-sm-6 col-sm-push-3" action="cikkek.php?kid=<?php print $ckid; ?>&cid=<?php print $cid; ?>" method="post" enctype="multipart/form-data">
...
?>
      ...
      <div class="checkbox">
<?php
        $sel = $akcios == 1 ? " checked" : "";
?>
        <label><input type="checkbox" name="akcios" id="akcios" value="1" <?php print $sel; ?>> Akcios</label>
      </div>

			<div class="form-group text-center">
        <input type="hidden" name="event" id="event" value="cikkek_mod_mentes">
